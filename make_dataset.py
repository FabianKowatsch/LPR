...
OUTPUT_FOLDER = 'data/obb/valid/labels'  # or 'path_to_your_output_folder'
LABEL_FOLDER = 'data/valid/labels'  # Folder with bbox labels (class center_x center_y width height)
...
def process_image(image_path):
    ...
    # No valid boxes? Just show the full image to click 4 points
    if not bboxes:
        print(f"No valid bboxes found for {image_name}, showing full image.")
        bboxes = [(0.5, 0.5, 1.0, 1.0)]  # Fake bbox covering entire image
